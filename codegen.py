"""
Generates Python code for entities module.

I did not want to manually hardcode these entities as Python Enums.
Hence I wrote this codegen script that'll read the Enum information
from a CSV file and outputs a Python file.
"""
import csv
...
def codegen_entities_py():
    ...
    import_stmt = "from enum import Enum"
